			...
			?>
				...
				<div class="dslc-tp-comment-form">
					...
					<?php else : 
						...
						global $commenter;
						comment_form( array(
							'label_submit' => __( 'Отправить', 'dslc_string' ),
							'cancel_reply_link' => 'cancel',
							'comment_notes_before' => '',
							'comment_notes_after' => '',
							'title_reply' => __( 'Оставить комментарий', 'dslc_string' ),
							'title_reply_to' => __( 'Reply to %s.', 'dslc_string'),
							'comment_field' => '<div class="comment-form-comment"><textarea id="comment" name="comment" placeholder="' . __( 'Ваш комментарий', 'dslc_string' ) . '" aria-required="true"></textarea></div>',
							'fields' => apply_filters( 'comment_form_default_fields', array(
								'author' => '<div class="comment-form-name"><input id="author" name="author" type=text value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" placeholder="' . __( 'Имя', 'dslc_string' ) . ' *" aria-required="true" /></div>',
								...
								'url' => '<div class="comment-form-website"><input id="url" name="url" type=text value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" placeholder="' . __( 'Ваш сайт', 'dslc_string' ) . '" /></div>'
							)),
						), $post_id); 
