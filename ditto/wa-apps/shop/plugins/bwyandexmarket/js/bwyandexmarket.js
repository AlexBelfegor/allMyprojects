$.extend($.importexport.plugins, {
    bwyandexmarket: {
        ...
        $form: null,
        init: function () {
            this.$form = $("#s-plugin-bwyandexmarket");
        },
        ...
        initForm: function () {
            ...
            this.$form.find('a.js-action').unbind('click').bind('click.bwyandexmarket', function () {
                try {
                    var $el = $(this);
                    ...
                    if (method.name) {
                        $.shop.trace('$.importexport.plugins.bwyandexmarket', method);
            ...
            this.$form.unbind('submit.bwyandexmarket').bind('submit.bwyandexmarket', function (event) {
                $.shop.trace('submit.bwyandexmarket ' + event.namespace, event);
                try {
                    var $form = $(this);
                    $form.find(':input, :submit').attr('disabled', false);
                    $.importexport.plugins.bwyandexmarket.bwyandexmarketHandler(this);
                } catch (e) {
                    $('#plugin-bwyandexmarket-transport-group').find(':input').attr('disabled', false);
                    $.shop.error('Exception: ' + e.message, e);
                }
                return false;
            });
        ...
        bwyandexmarketHandler: function (element) {
            var self = this;
            self.progress = true;
            self.form = $(element);
        ...
        progressHandler: function (url, processId, response) {
            ...
            var self = $.importexport.plugins.bwyandexmarket;
            var $bar;
            if (response && response.ready) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#plugin-bwyandexmarket-submit").hide();
                        self.form.find('.progressbar').hide();
                        var $report = $("#plugin-bwyandexmarket-report");
                        $report.show();
                        if (response.report) {
