...
class shopBwyandexmarketPluginBackendSetupAction extends waViewAction
{
    private $plugin_id = 'bwyandexmarket';
    ...
    public function execute()
    {
        ...
        if (!empty($profile['id'])) {
            $path = shopBwyandexmarketPlugin::path($profile['id'].'.xml');
