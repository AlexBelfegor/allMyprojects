 ...
 * 
 * При покупке X любых товаров устанавливается скидка на любое количество единиц Y товаров самой низкой цены из этого списка
 */
            ...
            if ($mult >= 1 && count($product_price) > 1) {
                ...
                foreach ($product_price as $pp) {
                    ...
                    if ($params['discount_percentage']) {
                        $discount += max(0.0, min(100.0, (float) $params['discount_percentage'])) * $pp['price'] * $mult / 100.0;
                    }
