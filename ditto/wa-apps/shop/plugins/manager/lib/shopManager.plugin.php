...
.'</em></span>'
    ...
    public function orderCreateAction($data)
    {
        $this->orderAction($data, true);
    }

    public function orderAction($data, $force = false)
    {
        if ($force || $this->getSettings('auto_assign')) {
    ...
    public static function getUsers()
    {
        if (self::$users === null) {
            ...
            $plugin = wa('shop')->getPlugin('manager');
